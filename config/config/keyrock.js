...
var database_pass = (process.env.DATABASE_PASS) ? process.env.DATABASE_PASS : '<secret>';
...
config.oauth2 = {
    ...
    access_token_lifetime: 60 * 60 * 60 * 146,      // Changed to one year
...
config.api = {
    ...
    token_lifetime: 60 * 60 * 60 * 146  // Changed to one year
}
